...
Queries used to help write base HTML and Javascript code for web app. I am not an experience web developer so I have have limited knowledge in the ins and outs of HTML and Javascript. I am better at reviewing, re-purposing, and updating code in order to make it work for my needs. AI is helping me to design the web application code to be integrated with my database, but all of the database design, data, and queries work is my own:
